...
//! queries, including the SQL query, and various structs in the
//! [`response`](queries::response) module for representing different query and
//! error responses from Druid.
//!
